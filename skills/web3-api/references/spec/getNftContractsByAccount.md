...
> Retrieve NFT contracts held by a specific account, grouped by contract with balance information.
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `page` | integer | No | Current page number (only if page param > 0) |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `totalBalance` | string | Yes | Total balance across all token IDs. For ERC721 same as uniqueBalance; for ERC1155 sums all quantities |
