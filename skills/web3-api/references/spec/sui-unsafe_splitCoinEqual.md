# sui-unsafe_splitCoinEqual

> Creates an unsigned transaction to split a coin into multiple coins of equal value.
...
3. **split_count** (`string`, required): The number of equal-value coins to create from the split.
