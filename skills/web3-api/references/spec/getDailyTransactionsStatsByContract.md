...
> Retrieves daily transaction count for a specific contract within a specified range.

- **Category**: Data API
- **Official Docs**: https://developer.nodit.io/reference/getDailyTransactionsStatsByContract
