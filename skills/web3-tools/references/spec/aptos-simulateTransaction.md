...
- **Official Docs**: https://developer.nodit.io/reference/aptos-simulateTransaction
...
|------|------|----------|-------------|
| `estimate_gas_price` | boolean | No | True transaction gas unit price value . |
| `estimate_max_gas` | boolean | No | True transaction max gas amount value . |
| `estimate_prioritized_gas_uint_price` | boolean | No | True transaction execution. |
